-- Improve get_user_company_id function for better multi-company context handling
...
-- Update user_streaks RLS policies for better multi-company support
...
-- Improve update_user_streak function with better logging
