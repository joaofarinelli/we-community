-- Fix streak rewards system

-- First, create a table to track awarded streak milestones to prevent duplicates
...
-- Fix the process_streak_rewards function to eliminate duplicate transactions
