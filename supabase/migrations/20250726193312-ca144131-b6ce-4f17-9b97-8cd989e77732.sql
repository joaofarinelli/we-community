-- Fix profiles table and create Cae Club company
DO $$
DECLARE
    new_company_id uuid;
    user_id_val uuid := 'e0f86579-0b6c-49f4-a291-5a17c6bbaf36';
BEGIN
    -- First, properly fix the profiles table constraints
    ALTER TABLE public.profiles DROP CONSTRAINT IF EXISTS profiles_user_id_key;
    
    -- Add composite unique constraint for user_id + company_id if it doesn't exist
    DO $inner$
    BEGIN
