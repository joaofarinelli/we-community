      ...
      <DialogContent className="max-w-2xl max-h-[90vh] p-0 bg-background">
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-4 pt-4 pb-4 border-b border-border">
            <Input placeholder="Título (opcional)" value={title} onChange={e => setTitle(e.target.value)} className="border-none bg-transparent font-medium placeholder:text-muted-foreground focus-visible:ring-0 focus:outline-none focus:ring-0 focus:border-transparent focus:shadow-none p-0" style={{
            fontSize: '24px'
          }} />
          </div>
